...
echo -e "\n\e[32mGenerating Images with guidolib\e[39m\n" && videogeneration $1 $2 && \
    ...
    echo -e "\n\e[32mAdding audio to generated video\e[39m\n" && ffmpeg -i output_dwatermarked.mp4 -i final_audio.mp3 -shortest -c copy almost_done.mp4 && \
    ...
    echo -e "\n\e[32mAdding text watermark\e[39m\n" && ffmpeg -i merged.mp4 -vf drawtext="fontfile=HelveticaNeueBd.ttf: text='Metronaut App': fontcolor=0x00000060: fontsize=20: x=(w-200): y=(h-text_h - 10)" -codec:a copy $6
